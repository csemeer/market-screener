    ...
    try {
      ...
      this.db.prepare(`
        INSERT OR REPLACE INTO trading_strategies (
          ...
          '{"useEMA":true,"emaFast":9,"emaMiddle":20,"emaSlow":50,"useRSI":true,"rsiPeriod":14,"useMACD":true,"macdFast":12,"macdSlow":26,"macdSignal":9,"useADX":true,"adxPeriod":14,"useBB":true,"bbPeriod":20,"bbStdDev":2,"useVolume":true,"volumePeriod":20,"useVWAP":true}',
          1,
          1,
          'system',
          1,
      ...
      this.db.prepare(`
        INSERT OR REPLACE INTO trading_strategies (
          ...
          '{"useEMA":true,"emaFast":9,"emaMiddle":20,"emaSlow":50,"useRSI":true,"rsiPeriod":14,"useMACD":true,"macdFast":12,"macdSlow":26,"macdSignal":9,"useBB":true,"bbPeriod":20,"bbStdDev":2,"useVolume":true,"volumePeriod":20}',
          1,
          1,
          'system',
          1,
      ...
      this.db.prepare(`
        INSERT OR REPLACE INTO trading_strategies (
          ...
          '{"useEMA":true,"emaFast":9,"emaMiddle":20,"emaSlow":50,"useRSI":true,"rsiPeriod":14,"useMACD":true,"macdFast":12,"macdSlow":26,"macdSignal":9,"useBB":true,"bbPeriod":20,"bbStdDev":2,"useVolume":true,"volumePeriod":20,"useVWAP":true}',
          1,
          1,
          'system',
          1,
