...
import { Search, Filter, TrendingUp, TrendingDown, LayoutGrid, Table, ListTree, Eye } from 'lucide-react';
...
import { transformScreenerToUnified } from '../utils/stockDataHelpers';
...
export default function Screener() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      ...
      {selectedStock && (
        <UnifiedStockModal
          stock={transformScreenerToUnified(selectedStock)}
